...
![killchain-buffer_overflow-architecture-memory.png](../../_attachments/killchain-buffer_overflow-architecture-memory.png)
Source: TCM Security
...
![killchain-buffer_overflow-architecture-stack.png](../../_attachments/killchain-buffer_overflow-architecture-stack.png)
Source: TCM Security
...
````
 ...
 > ![exploit-buffer_overflow-eip_manual.png](../../_attachments/exploit-buffer_overflow-eip_manual.png)
...
![exploit-buffer_overflow-eip_mona.png](../../_attachments/exploit-buffer_overflow-eip_mona.png)
...
````
 ...
 > ![exploit-buffer_overflow-bad_chars_manual_1.png](../../_attachments/exploit-buffer_overflow-bad_chars_manual_1.png)

 > 
 > Check if all chars are here in right order.
 > ![exploit-buffer_overflow-bad_chars_manual_2.png](../../_attachments/exploit-buffer_overflow-bad_chars_manual_2.png)
...
![exploit-buffer_overflow-bad_chars_mona.png](../../_attachments/exploit-buffer_overflow-bad_chars_mona.png)
...
![exploit-buffer_overflow-jump_point_mona.png](../../_attachments/exploit-buffer_overflow-jump_point_mona.png)
